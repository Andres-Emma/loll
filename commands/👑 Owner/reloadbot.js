...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let guild = client.guilds.cache.get("843200863647301653")
      return message.reply({content : `**<a:no:892135170054967360> THIS COMMAND IS DISABLED, go to <#934525099770515476> to get it restarted!**\n\n\n> **Path:**
\`\`\`yml
/home/container/servicebots/CLANBOTS/doctorstars_itzemma_clanbot
\`\`\`
> **Server:**
\`\`\`yml
...
> **Command:**
\`\`\`yml
pm2 list | grep "doctorstars_itzemma_clanbot" --ignore-case
\`\`\`
${clientapp ? `
