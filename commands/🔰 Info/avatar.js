  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let embed = new MessageEmbed()
        ...
        .addField("<:arrow:932072699755397150> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
        .addField("<:arrow:932072699755397150> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<:arrow:932072699755397150> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
