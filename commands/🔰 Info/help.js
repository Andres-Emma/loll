  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("913998239018143764").setLabel("Discord").setURL("https://discord.gg/2WHg3Qs6AK")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
...
<:DoctorStars:934519298142117898>  Made by [**DoctorStars Development**](https://discord.gg/2WHg3Qs6AK)`)
